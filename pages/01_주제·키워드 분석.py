...
if not kw.empty:
    ...
    matched = df[(df["title"].fillna("") + " " + df["summary"].fillna("") + " " + df["author"].fillna("") + " " + df["metadata_text"].fillna("") + " " + df["body"].fillna("")).str.contains(re.escape(selected_keyword), case=False, na=False)].copy()
